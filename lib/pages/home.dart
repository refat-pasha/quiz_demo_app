        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              right: 0,
              top: -20,
              child: Image.asset(img, width: 90, height: 90),
            ),
          ],
        ),
      );
          ...
          child: Column(
            ...
            children: [
              ...
              buildCard(
                1,
                'Travel Newb',
                [Color(0xFFEF729E), Color(0xFFEC7C86), Color(0xFFED896D)],
                Icons.done,
              ...
              buildCard(
                2,
                'Continuing',
                [Color(0xFF4446C7), Color(0xFF37469E), Color(0xFF7072C5)],
                Icons.play_arrow,
              ...
              buildCard(
                3,
                'Experienced',
                [Color(0xFF54CF79), Color(0xFF33B469), Color(0xFF13A744)],
                Icons.lock,
              ...
              buildCard(
                4,
                'Question',
                [Color(0xFF9540AF), Color(0xFF8B1D99), Color(0xFF8E09A0)],
                Icons.next_plan,
                'images/airballon.png',
              ),
              const SizedBox(height: 30),
